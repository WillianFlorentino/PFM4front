...
export default function TabelaItensPlano(props) {
    // var totalPlanos = 0;
    return (
            ...
            <tbody>
                {
                    props.listaItens?.map((item, indice) => {
                        // totalPlanos+= parseFloat(item.subtotal);
                        ...
                        return <tr key={indice}>
                            ...
                            <td>
                                <Button onClick={()=>{
                                    ...
                                    props.setPlano({...props.dadosPlano, itens:lista});
                                }}>
        ...
        {/* <p>Total da Venda: {totalPlanos}</p> */}
        </Container>
    )
}